...
$pdf->MultiCell(55, 5, utf8_decode("TICKETS"), 0, 'C');
$pdf->MultiCell(65, 5, utf8_decode($datos['nombre']), 0, 'C');
$pdf->image("../../assets/images/logosdcreations.jpg", 60, 20, 15, 15, 'PNG');
...
$pdf->SetFont('Arial', '', 8);
$pdf->MultiCell(50, 5, utf8_decode($datos['email']), 0, 'L');
$pdf->Ln(3);
...
$pdf->SetFont('Arial', '', 8);
$pdf->MultiCell(50, 5, utf8_decode($datosC['nombre']), 0, 'L');
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(15, 5, utf8_decode('Teléfono:'), 0, 0, 'L');
$pdf->SetFont('Arial', '', 8);
$pdf->MultiCell(18, 5, utf8_decode($datosC['telefono']), 0, 'L');
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(15, 5, utf8_decode('Dirección:'), 0, 0, 'L');
$pdf->SetFont('Arial', '', 8);
$pdf->MultiCell(50, 5, utf8_decode($datosC['direccion']), 0, 'L');
$pdf->Ln(3);
