                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="form-group">
                            ...
                            <input id="producto" class="form-control" type="text" name="producto" placeholder="Buscar Producto">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input id="cantidad-venta" class="form-control" type="text" name="cantidad" placeholder="Cantidad">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group">
